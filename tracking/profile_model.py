...
def evaluate_vit(model, template, search):
    '''Speed Test'''
    # print("template[0]", template[0].shape) # template[0] torch.Size([1, 3, 128, 128])
    # print("template[1]", template[1].shape) # template[1] torch.Size([1, 3, 128, 128])
...
if __name__ == "__main__":
    ...
    if args.script == "tbsi_track":
        ...
        template_list_v = [template,template]
        template_list_i = [template,template]
        template_list = [template_list_v, template_list_i]
